...
class LoRA(nn.Module):
    def __init__(
        ...
        # self.bayes_A = BayesLinear(prior_mu=0, prior_sigma=0.005,
        #                            in_features=lora_A_shape[1], out_features=lora_A_shape[0], bias=False)

        # self.bayes_B = BayesLinear(prior_mu=0, prior_sigma=0.005,
        #                            in_features=lora_B_shape[1], out_features=lora_B_shape[0], bias=False)
    ...
    def forward(self, hidden_states: Optional[torch.Tensor], layer_input: torch.Tensor):
        ...
        hidden_states = self.bayes_A(dropped)@self.lora_B.T
